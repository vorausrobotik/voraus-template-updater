...
project = "voraus Template Updater"
...
release = importlib_metadata.version("voraus-template-updater")
...
htmlhelp_basename = "voraus_template_updaterdoc"
...
latex_documents = [
    (
        "index",
        "voraus_template_updater.tex",
        "voraus Template Updater Documentation",
        "Felipe Peter",
        "manual",
    ),
]
